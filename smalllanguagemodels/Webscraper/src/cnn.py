...
class MushroomCNN:
    ...
    def load_data(self):
        print("\nLoading augmented mushroom data with smart train/test split...")
        
        # Pfad zu den augmentierten Daten
        data_path = Path("Webscraper/data/augmented_mushrooms/resized")
        ...
        # Sammle alle Bilder gruppiert nach Basisnummer
        ...
        # === INTELLIGENTE TRAIN/TEST AUFTEILUNG ===
        ...
        # Lade die tatsächlichen Bilddaten
        print("\n4. Lade Bilddaten...")
        ...
        # Labels zu kategorisch konvertieren
    ...
    def load_external_test_data(self):
        """Lädt externe Testdaten aus Webscraper/data/test_mushrooms"""
        print("\nLoading external test data from Webscraper/data/test_mushrooms...")
        ...
        # Alle Bilddateien im flachen Verzeichnis finden
        for file_path in test_path.iterdir():
            if file_path.is_file() and file_path.suffix.lower() in image_extensions:
                filename = file_path.name.lower()
                
                # Bestimme Klasse basierend auf Dateinamen
                class_idx = None
                for i, class_name in enumerate(self.class_names):
...
if __name__ == "__main__":
    ...
    #ä#
    print("Testing: External test data from Webscraper/data/test_mushrooms")
    print("=" * 60)
    
    # Create and train the model
    cnn = MushroomCNN()
    history = cnn.train(epochs=30, use_external_test=True)  # Verwende externe Testdaten
