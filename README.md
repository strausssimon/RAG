...
│
├── data/  
│   ├── augmented_mushrooms/       # leer aufgrund Speicherbegrenzung FOM 256 MB
│   │   ├── inaturalist/
│   │   │   ├── Amanita_muscaria
│   │   │   │   └── ...
│   │   │   ├── ...
...
│   │           └── ...    
│   │
│   ├── cropped_mushrooms           # leer aufgrund Speicherbegrenzung FOM 256 MB
│   │    ├── Cropped_Amanita_muscaria
│   │    │   └── ...
│   │    ├── ...
│   │    │   └── ...
│   │    └── Cropped_Phallus_impudicus
│   │           └── ... 
│   │
│   ├── csv                         # CSV für Scraper
│   │   ├── inaturalist         
...
│   │       └── ...
│   │
│   ├── kaggle_mushrooms            # leer aufgrund Speicherbegrenzung FOM 256 MB
│   │   └── mushroom_dataset
...
│   │
│   ├── mushroomobserver            # leer aufgrund Speicherbegrenzung FOM 256 MB
│   │   ├── Agaricus_arvensis
│   │   │   └── ...
│   │   ├── ...
│   │   │   └── ...
...
│   │       └── Phallus_impudicus
│   │ 
│   ├── recolored_mushrooms         # grün->grau // leer aufgrund Speicherbegrenzung FOM 256 MB
│   │   └── inaturalist
│   │       ├── Amanita_muscaria
│   │       │   └── ...
│   │       ├── Armillaria_mellea
