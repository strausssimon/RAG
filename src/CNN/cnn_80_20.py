...
logfile = open("cnn_80_20_output_log.txt", "w", encoding="utf-8")
...
if __name__ == "__main__":
    ...
    print("=" * 90)
    print("Classes: Amanita_muscaria, Boletus_edulis, Armillaria_mellea, Tylopilus_felleus, Suillellus_luridus, Amanita_phalloides, Imleria_badia")
    print("Architecture: ResNet-inspired with Residual Connections + GlobalAveragePooling2D")
    print("Improvements: Skip Connections, Reduced Parameters, Better Gradient Flow")
    ...
    if history is not None:
        ...
        cnn.save_model("models/mushroom_5class_resnet_cnn_80_20.keras")
