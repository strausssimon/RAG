...
class MushroomCropper:
    ...
    def __init__(self, source_dir="Webscraper\data\images_mushrooms\Armillaria_mellea",
                 output_dir="Webscraper/data/cropped_mushrooms/Cropped_Armillaria_mellea",
...
def main():
    ...
    # Standard-Pfade
    source = "Webscraper/data/images_mushrooms/Armillaria_mellea"
    target = "Webscraper/data/cropped_mushrooms/Cropped_Armillaria_mellea"
